// main.js - Using your local images folder
const movies = {
    bollywood: [
    ...
    hollywood: [
        ...
        { id: 6, title: 'Oppenheimer', genre: 'Biography/Thriller', language: 'English', duration: '3h 0m', rating: '9.2', seats: 41, image: 'images/oppenheimer.jpg', price: { regular: 200, premium: 350, vip: 500 } },
        { id: 7, title: 'Final Destination Bloodlines', genre: 'Horror/Thriller', language: 'Hindi', duration: '1h 54m', rating: '8.3', seats: 57, image: 'images/final destination bloodlines.jpg', price: { regular: 200, premium: 350, vip: 500 } },
        { id: 8, title: 'Mission: Impossible', genre: 'Action/Adventure', language: 'English', duration: '2h 43m', rating: '8.7', seats: 48, image: 'images/Mission Impossible.jpg', price: { regular: 200, premium: 350, vip: 500 } }
    ],
    south: [
        ...
        { id: 10, title: 'RRR', genre: 'Action/Drama', language: 'Telugu', duration: '3h 7m', rating: '9.1', seats: 44, image: 'images/rrr.jpg', price: { regular: 150, premium: 250, vip: 350 } },
        { id: 11, title: 'Vikram', genre: 'Action/Thriller', language: 'Tamil', duration: '2h 55m', rating: '8.8', seats: 36, image: 'images/vikram.jpg', price: { regular: 150, premium: 250, vip: 350 } },
        { id: 12, title: 'Pushpa', genre: 'Action/Drama', language: 'Telugu', duration: '2h 59m', rating: '8.5', seats: 40, image: 'images/pushpa.jpg', price: { regular: 150, premium: 250, vip: 350 } }
    ]
};
...
const comingSoon = [
    ...
    { title: 'Dhurandhar', releaseDate: 'Oct 2025', image: 'images/Dhurandhar.jpg' },
    { title: 'Harry Potter', releaseDate: 'Dec 2026', image: 'images/Harry Potter.jpg' }
];
...
function displayComingSoon() {
    ...
    comingSoon.forEach(movie => {
        ...
        card.innerHTML = `<div class="coming-poster"><img src="${movie.image}" alt="${movie.title}" onerror="this.src='https://via.placeholder.com/300x400/1a1a2e/ffffff?text=${movie.title.replace(/ /g, '+')}'"></div><div class="coming-info"><h4>${movie.title}</h4><span class="release-date">${movie.releaseDate}</span></div>`;
...
function createMovieCard(movie) {
    ...
    card.innerHTML = `
        <div class="movie-poster"><img src="${movie.image}" alt="${movie.title}" onerror="this.src='https://via.placeholder.com/300x400/1a1a2e/ffffff?text=${movie.title.replace(/ /g, '+')}'"><span class="movie-rating"><i class="fas fa-star"></i> ${movie.rating}</span></div>
